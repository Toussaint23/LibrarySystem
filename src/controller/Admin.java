...
/*	public static void main(String[] args) {
		...
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("Essaie");
		...
		// em.getTransaction().commit();
		 ...
		 Retrieve entity 
		// paysan = em.find(Paysan.class, 2);
		// System.out.println(paysan);

		 Retrieve all entities 
		// @SuppressWarnings("unchecked")
		// List<Paysan> paysans = em.createNamedQuery("Paysan.findAll").getResultList();
		// System.out.println(paysans);
		...
		em.createNamedQuery("Paysan.updateAll");
