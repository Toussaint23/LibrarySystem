...
public class MemberAccountFactory {
	...
	public static MemberAccountImpl createMemberAndAccount(String id, String email, String firstName, int isSuperMember, String lastName, String user, String pwd) {
